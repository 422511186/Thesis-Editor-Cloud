...
//        String authName = AuthUtils.getAuthentication().getName();
//        /*工作目录地址拼接*/
...
//
//        if (!AuthUtils.getAuthentication().getName().equals(auth))
...
//        MyUserDetails userDetails = AuthUtils.getMyUserDetails();
...
//        MyUserDetails userDetails = AuthUtils.getMyUserDetails();
//        assert userDetails != null && userDetails.getUser() != null;
//        String userName = userDetails.getUser().getUserName();
//
//        Document document = new Document();
//        document.setAuth(userName);
